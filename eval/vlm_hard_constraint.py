...
# ── 硬约束关键词映射（32 主题：n=10 辅池 + n=22 主池，覆盖 benchmark 全集）───
# key = BenchInput.user_input，value = {"kw": [...], "density": "rich"/"sparse"}
# rich = 用户显式指定 2 个具体物体（"要有 X 和 Y"）→ 判 X✓ + Y✓
# sparse = 只给主题词 → 判"场景类关键词"是否命中（判定标准更宽松）
HARD_CONSTRAINTS: Dict[str, Dict[str, Any]] = {
    # ── n=10 辅池（backend 03-03）─────────────────────────────
    "写一首春景的五言绝句，要有柳树和燕子": {
    ...
    # ── n=22 主池（backend 04-22，主题 11-32 补数据）──────────
    "写一首秋景的五言律诗，要有疏桐和寒蛩": {
        "kw": ["桐树", "蛩（蟋蟀）"], "density": "rich",
    },
    "写一首七言律诗，主题是悲秋": {
        "kw": ["悲秋场景（落叶/凋零/萧瑟/秋色）"], "density": "sparse",
    },
    "写一首五言绝句，主题是寒梅": {
        "kw": ["梅花"], "density": "sparse",
    },
    "写一首冬景的七言绝句，要有飞雪和寒鸦": {
        "kw": ["雪", "寒鸦（乌鸦）"], "density": "rich",
    },
    "写一首五言律诗，主题是雪夜": {
        "kw": ["雪夜场景（雪 + 夜色）"], "density": "sparse",
    },
    "写一首冬景的七言律诗，要有炉火和寒灯": {
        "kw": ["炉火（火焰）", "寒灯（灯）"], "density": "rich",
    },
    "写一首五言绝句，主题是溪声": {
        "kw": ["溪水（水流/溪流）"], "density": "sparse",
    },
    "写一首五言律诗，主题是归隐": {
        "kw": ["归隐场景（茅屋/山居/隐士）"], "density": "sparse",
    },
    "写一首边塞的五言律诗，要有戍楼和角声": {
        "kw": ["戍楼（烽火台/城楼/箭楼）", "边塞角声场景（军旗/号角/军营）"],
        "density": "rich",
    },
    "写一首七言绝句，主题是送别": {
        "kw": ["送别场景（分别/挥手/离别酒/长亭/柳枝）"], "density": "sparse",
    },
    "写一首送别的七言律诗，要有长亭和折柳": {
        "kw": ["长亭", "柳枝（折柳）"], "density": "rich",
    },
    "写一首怀古的五言律诗，要有古城和荒台": {
        "kw": ["古城（残城/城墙）", "荒台（废弃高台/遗迹）"], "density": "rich",
    },
    "写一首七言律诗，主题是吊古": {
        "kw": ["吊古场景（残垣/断碑/苍凉遗迹）"], "density": "sparse",
    },
    "写一首中秋的五言绝句，要有明月和团圆": {
        "kw": ["明月（圆月）", "团圆场景（家人聚会/圆桌）"], "density": "rich",
    },
    "写一首五言律诗，主题是重阳": {
        "kw": ["重阳场景（登高/菊花/茱萸）"], "density": "sparse",
    },
    "写一首禅意的七言绝句，要有古刹和钟鼓": {
        "kw": ["古刹（寺庙/佛塔）", "钟鼓（钟或鼓）"], "density": "rich",
    },
    "写一首五言绝句，主题是无常": {
        "kw": ["无常主题场景（枯萎/凋零/流水/逝去/孤影）"], "density": "sparse",
    },
}
